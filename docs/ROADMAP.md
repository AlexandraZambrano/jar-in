...
- **2026-09-07** — **0012 follow-ups** — flow-jar opening balance now persists (`jarsRepo` was resetting it to 0 for non-accumulation jars); flow Home card / detail line reshaped to the same 3-segment `·` format as growth jars.
